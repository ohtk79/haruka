// =============================================================================
// JIS 109 Keyboard Template Data
// =============================================================================
...
const keys: PhysicalKey[] = [
	...
	// =========================================================================
	{ id: 'Backquote', label: '半角/\n全角', kanataName: 'grv', x: 0, y: 1.5, width: 1, height: 1 },
	...
	{ id: 'IntlYen', label: '¥', kanataName: '¥', x: 13, y: 1.5, width: 1, height: 1 },
	{ id: 'Backspace', label: 'Back\nspace', kanataName: 'bspc', x: 14, y: 1.5, width: 1, height: 1 },
	// Nav cluster row 1
	...
	// Enter occupies 13.5~15, row 2-3 (iso-enter shape, already defined in row 2)
	// Numpad row 3
	...
	{ id: 'AltLeft', label: 'Alt', kanataName: 'lalt', x: 2.75, y: 5.5, width: 1.25, height: 1 },
	{
		id: 'NonConvert',
		label: '無変換',
		kanataName: 'mhnk',
