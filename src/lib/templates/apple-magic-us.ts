// =============================================================================
// Apple Magic Keyboard US (Full-size) Template Data
// =============================================================================
// ~109 keys with coordinates in key units (1u = standard key width)
// viewBox: "0 0 23 6.5"
// Cluster layout: Main(0~15u) + gap + Nav(15.5~17.5u) + gap + Numpad(19~23u)
//
// KE 専用テンプレート（kanata .kbd 非対応）
// ANSI 104 との差分:
//   追加: Fn キー（kanataName なし）, F13-F19, NumpadEqual (kp=)
//   追加: ContextMenu (nav cluster row 1)
//   削除: PrtSc, ScrLk, Pause, Insert
//   変更: ファンクション行に 0.25u ギャップ（Esc後、F4後、F8後）
...
const keys: PhysicalKey[] = [
	...
	// Apple US: fn(1u), Ctrl(1u), Opt(1u), Cmd(1.25u), Space(6u), Cmd(1.5u), Opt(1.5u), Ctrl(1.75u) = 15u
	// =========================================================================
	{ id: 'Fn', label: 'fn', kanataName: 'fn', x: 0, y: 5.5, width: 1, height: 1 },
	{ id: 'ControlLeft', label: 'Ctrl', kanataName: 'lctl', x: 1, y: 5.5, width: 1, height: 1 },
	{ id: 'AltLeft', label: 'Opt', kanataName: 'lalt', x: 2, y: 5.5, width: 1, height: 1 },
	{ id: 'MetaLeft', label: 'Cmd', kanataName: 'lmet', x: 3, y: 5.5, width: 1.25, height: 1 },
	{ id: 'Space', label: 'Space', kanataName: 'spc', x: 4.25, y: 5.5, width: 6, height: 1 },
	{ id: 'MetaRight', label: 'Cmd', kanataName: 'rmet', x: 10.25, y: 5.5, width: 1.5, height: 1 },
	{ id: 'AltRight', label: 'Opt', kanataName: 'ralt', x: 11.75, y: 5.5, width: 1.5, height: 1 },
	{ id: 'ControlRight', label: 'Ctrl', kanataName: 'rctl', x: 13.25, y: 5.5, width: 1.75, height: 1 },
	// Nav cluster row 5
...
export const APPLE_MAGIC_US_TEMPLATE: LayoutTemplate = {
	id: 'apple-us',
	name: '109(US) Apple専用',
	keys,
